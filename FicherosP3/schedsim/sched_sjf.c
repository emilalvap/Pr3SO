...
void sched_init_sjf(void) {}

void sched_destroy_sjf(void) {}
  
static void task_new_sjf(task_t* t){ }
...
sched_class_t sjf_sched={
    .sched_init=sched_init_sjf,
    .sched_destroy=sched_destroy_sjf,      
    .task_new=task_new_sjf,
